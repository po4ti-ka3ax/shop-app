...
// import placeholderImg from "../../../../public/img/photoPlaceholder.jpg"
...
export default function Products()  {
    ...
    function saveProduct(id: number) {
        const storedData = JSON.parse(localStorage.getItem("ProductsId")) || [];
    ...
    return (
        <div>
        <button className="ml-[15px] cursor-pointer border-[1px] rounded-[5px] p-[3px] hover:bg-black hover:text-[#fff] duration-200" onClick={() => router.back()}>Go back</button>
            ...
            <div className="mt-[40px] flex justify-center">
                <button className="cursor-pointer border-[1px] rounded-[5px] p-[3px] mr-[10px] hover:bg-black hover:text-[#fff] duration-200" onClick={() => fetchData()}>Refresh</button>
                <button className="cursor-pointer border-[1px] rounded-[5px] p-[3px] mr-[10px] bg-blue-500 text-[#fff] hover:bg-blue-700 hover:text-[#fff] duration-200" onClick={() => saveProduct(id)}>Add to cart</button>
